...
In the Sutras the principle is laid down that the sacrifices are to be dis- tinguished as Prakṛtis and Vikṛtis, the former being the base on which the later are built up; thus the new- and full-moon sacrifices are the model for other sacrifices of the type known as Iṣṭi, and for the animal sacrifice, in its form as an offering to Agni and Soma, on which further animal offerings are based. The Agnistoma again is the fundamental form of the Soma sacrifice: 
